...
author: "Prof. Dr. Wouter van Atteveldt"
format:
  revealjs: 
...
.people-table td {
  width: 12.5%; /* or however many columns you have */
  text-align: center;
  vertical-align: top;
}
.people-table td img {
...
![](img/wouter_van_atteveldt.png){.absolute bottom="150" right="100" width="200"}
...
![](img/text_as_data/text_01.png)

# From text to numbers

In automated text classification, we use understandings of morphology (and other fields of linguistics) to break text into tokens and then represent these tokens as numbers, so that a computer can read them:

![](img/text_as_data/text_02.png)

# From text to numbers

In automated text classification, we use understandings of morphology (and other fields of linguistics) to break text into tokens and then represent these tokens as numbers, so that a computer can read them:

![](img/text_as_data/text_03.png)

# From text to numbers

In automated text classification, we use understandings of morphology (and other fields of linguistics) to break text into tokens and then represent these tokens as numbers, so that a computer can read them:

![](img/text_as_data/text_04.png)

# From text to numbers

In automated text classification, we use understandings of morphology (and other fields of linguistics) to break text into tokens and then represent these tokens as numbers, so that a computer can read them:

![](img/text_as_data/text_05.png)

# From text to numbers

In automated text classification, we use understandings of morphology (and other fields of linguistics) to break text into tokens and then represent these tokens as numbers, so that a computer can read them:

![](img/text_as_data/text_06.png)
...
<br><br> [Salganik, 2018, chap. 6]{style="font-size:0.65em;"}
...
::: {.people-table}
| prof. dr. Wouter van Atteveldt |    Gianni Quaedvlieg |     dr. Kasper Welbers |    dr. Sophia Gil-Clavel |  dr. Alberto López Ortega |
|:---------:|:---------:|:---------:|:---------:|:---------:|
| ![](img/wouter_scaled.png) |   ![](img/gianni_scaled.jpg) |  ![](img/kasper.jpg) |   ![](https://assets-us-01.kc-usercontent.com/d8b6f1f5-816c-005b-1dc1-e363dd7ce9a5/c26da8f9-5a95-4069-a141-edeef590f5b7/Interview%20Sofia%20%281%29.jpg) |  ![](https://puredataprod.azureedge.net/5c26bb17-5425-45d6-b263-42916550b6fa.jpg) | 
| Lecturer & <br/> Course Coordinator |  Teacher & <br/> Workgroup Coordinator|   Teacher |   Teacher | Teacher |
:::
