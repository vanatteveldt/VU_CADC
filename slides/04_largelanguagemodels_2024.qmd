...
![Source: Wikipedia](img/marenostrum.jpg)


## Overview of the GPT-series by OpenAI

![Source: Wikipedia](img/gpt-series-training.png)
...
```{r}
#save(results_llama, file = "results/results_llama.RData")
...
::: {.column width="48%"}
```{r, echo = F}
#save(predict_nn, file = "results/predict_nn.RData")
load("results/predict_nn.RData")
#save(predict_gpt, file = "results/predict_gpt.RData")
...
![](https://web.archive.org/web/20250209195421if_/https://hai.stanford.edu/sites/default/files/inline-images/AIIndex_2023_StateofAI_Blog_4.jpg)
...
![](https://mir-s3-cdn-cf.behance.net/project_modules/max_1200/ea5cab25137457.563425fa7c93f.png)
